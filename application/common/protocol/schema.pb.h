...
typedef enum flight_state {
    FLIGHT_STATE_IDLE = 0,
    FLIGHT_STATE_AWAITING_INIT = 1,
    FLIGHT_STATE_INITATED = 2,
    FLIGHT_STATE_AWAITING_LAUNCH = 3,
    FLIGHT_STATE_BOOST = 4,
    FLIGHT_STATE_COAST = 5,
    FLIGHT_STATE_FREE_FALL = 6,
    FLIGHT_STATE_DROGUE_DESCENT = 7,
    FLIGHT_STATE_MAIN_DESCENT = 8,
    FLIGHT_STATE_LANDED = 9
} flight_state_t;
